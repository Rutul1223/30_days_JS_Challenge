...
const numbers = [64, 35.25, 12, 22, 11, 90];
...
console.log("Sorted array:", selectionSort(numbers1));
...
console.log("Sorted array:", quickSort(numbers2));
...
console.log(`Index of target value ${target1}:`, index1);
